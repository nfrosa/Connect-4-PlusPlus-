#ifndef projectpart2_h
#define projectpart2_h
...
//class for computer aka AI players
class Computer: public Player
{
	...
	public:
		Computer(string n, string s, int d)
		{
        name = n;
        shape = s;
        difficulty = d;
...
//HARD DIFFICULTY NOT DONE. WILL FINISH AFTER TESTING
